...
class _FontFamilyItem extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final fontFamily =
        ref.read(themeSettingProvider.select((state) => state.fontFamily));
...
class _PrimaryColorItem extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final primaryColor =
        ref.read(themeSettingProvider.select((state) => state.primaryColor));
...
class _PrueBlackItem extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final prueBlack =
        ref.read(themeSettingProvider.select((state) => state.prueBlack));
    return Padding(
