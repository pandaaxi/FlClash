    ...
    return generateSection(
      ...
      items: [
        SingleChildScrollView(
          ...
          child: Consumer(
            builder: (_, ref, __) {
              final proxiesType = ref.read(proxiesStyleSettingProvider.select(
                (state) => state.type,
              ));
              return Wrap(
                spacing: 16,
    ...
    return generateSection(
      ...
      items: [
        SingleChildScrollView(
          ...
          child: Consumer(
            builder: (_, ref, __) {
              final sortType = ref.read(proxiesStyleSettingProvider.select(
    ...
    return generateSection(
      ...
      items: [
        SingleChildScrollView(
          ...
          child: Consumer(
            builder: (_, ref, __) {
              final cardType = ref.read(proxiesStyleSettingProvider.select(
    ...
    return generateSection(
      ...
      items: [
        SingleChildScrollView(
          ...
          child: Consumer(
            builder: (_, ref, __) {
              final layout = ref.read(proxiesStyleSettingProvider.select(
                (state) => state.layout,
              ));
              return Wrap(
                spacing: 16,
    ...
    return generateSection(
      ...
      items: [
        SingleChildScrollView(
          ...
          child: Consumer(
            builder: (_, ref, __) {
              final iconStyle = ref.read(proxiesStyleSettingProvider.select(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Consumer(
            builder: (_, ref, child) {
              final isList = ref.read(proxiesStyleSettingProvider
